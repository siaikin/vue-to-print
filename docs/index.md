...
hero:
  name: "Vue To Print"
  text: "Print Vue components in the browser"
  actions:
    - theme: brand
      text: Get Started
    ...
    - theme: alt
      text: View on Github
      link: https://github.com/siaikin/vue-to-print
...
features:
  ...
  - icon: 🤖
    ...
    details: Two comprehensive documentation formats available - compact llms.txt for quick reference and llms-full.txt for complete API documentation, optimized for AI programming assistants.
---
